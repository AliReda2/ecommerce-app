...
export default function UserOrdersPage() {
  ...
  if (error)
    return <p className="p-10 text-red-500 text-center font-medium">{error}</p>;

  if (!userOrders.length)
    return (
      <p className="p-10 text-gray-600 text-center font-medium">
      ...
      {userOrders.map((order) => (
        ...
        >
          ...
          <CardContent className="space-y-3 p-4 flex flex-col flex-1">
            ...
            {/* Spacer pushes the total section to the bottom */}
